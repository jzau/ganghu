...
const legalText: Record<Language, Record<LegalPageKind, {
  ...
  en: {
    terms: {
      ...
      sections: [
        {
          heading: "Visitor Sessions",
          body: [
            "You can use chat without creating an account. A browser cookie keeps your conversation history available on this device.",
            "Anyone using this browser may be able to see its conversation history. Clearing cookies may make that history inaccessible."
          ]
        },
        {
        ...
        },
        {
          ...
          body: [
            "Chat is available without login or recharge. Model availability may change over time.",
      ...
      sections: [
        {
          ...
          body: [
            "We collect a browser session identifier, model selections, conversations, and shared conversation links.",
        ...
        },
        {
          ...
          body: [
            "We use information to provide chat features, maintain conversation history, troubleshoot issues, improve reliability, and protect against misuse.",
      ...
      sections: [
        {
          heading: "访客会话",
          body: [
            "无需创建账户即可聊天。浏览器 Cookie 会让您在此设备上继续查看对话历史。",
            "使用此浏览器的其他人可能看到对话历史；清除 Cookie 后，历史记录可能无法找回。"
          ]
        },
        {
          heading: "可接受使用",
      ...
      sections: [
        {
          heading: "我们收集的信息",
          body: [
            "我们会收集浏览器会话标识、模型选择、对话内容以及分享对话链接。",
        ...
        },
        {
          heading: "信息使用方式",
          body: [
            "我们使用信息来提供聊天功能、维护对话历史、排查问题、提升可靠性并防止滥用。",
  ...
  return (
    <div className="gg-legal-page">
      <header className="gg-legal-page-header">
        <button className="gg-legal-close" onClick={() => { if (window.history.length > 1) navigate(-1); else navigate("/"); }} aria-label={language === "en" ? "Close" : "关闭"}><X size={18} /></button>
      </header>

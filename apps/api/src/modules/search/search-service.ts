...
const providers = {
  ...
  "doubao-search": new DoubaoSearchProvider(env.DOUBAO_SEARCH_API_KEY, env.DOUBAO_SEARCH_BASE_URL)
};
const gateways = {
  ...
  "doubao-search": new SearchGateway(providers["doubao-search"], env.SEARCH_TIMEOUT_MS)
};
